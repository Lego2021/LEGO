CREATE EXTENSION worker_spi;
 ...
 DO $$ DECLARE visible bool;
 loops int := 0;
 BEGIN LOOP visible := table_name IS NOT NULL FROM information_schema.tables WHERE table_schema = 'schema4' AND table_name = 'counted';
 ...
 loops int := 0;
 BEGIN LOOP count := count(*) FROM schema4.counted WHERE type = 'delta';
