CREATE EXTENSION adminpack;
 ...
 DROP ROLE regress_user1;
  SELECT pg_file_sync('test_file1');
 -- sync file SELECT pg_file_sync('pg_stat');
 -- sync directory SELECT pg_file_sync('test_file2');
 -- not there  SELECT pg_file_rename('test_file1', 'test_file2');
 SELECT pg_read_file('test_file1');
  -- not there SELECT pg_read_file('test_file2');
 ...
 SELECT pg_read_file('test_file2');
  -- not there SELECT pg_read_file('test_file3');
 SELECT pg_read_file('test_file3_archive');
   SELECT pg_file_unlink('test_file1');
  -- does not exist SELECT pg_file_unlink('test_file2');
  -- does not exist SELECT pg_file_unlink('test_file3');
