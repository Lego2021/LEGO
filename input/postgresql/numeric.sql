 ...
 INSERT INTO fract_only VALUES (3, '1.0');
    -- should fail INSERT INTO fract_only VALUES (4, '-0.9999');
 INSERT INTO fract_only VALUES (5, '0.99994');
 INSERT INTO fract_only VALUES (6, '0.99995');
  -- should fail INSERT INTO fract_only VALUES (7, '0.00001');
 INSERT INTO fract_only VALUES (8, '0.00017');
 INSERT INTO fract_only VALUES (9, 'NaN');
 INSERT INTO fract_only VALUES (10, 'Inf');
    -- should fail INSERT INTO fract_only VALUES (11, '-Inf');
    -- should fail SELECT * FROM fract_only;
 ...
 -- error SELECT width_bucket(0.0::numeric, 5, '-Infinity'::numeric, 20);
 -- error SELECT width_bucket('Infinity'::numeric, 1, 10, 10), width_bucket('-Infinity'::numeric, 1, 10, 10);
 SELECT width_bucket(0.0::float8, 'Infinity'::float8, 5, 10);
 -- error SELECT width_bucket(0.0::float8, 5, '-Infinity'::float8, 20);
 -- error SELECT width_bucket('Infinity'::float8, 1, 10, 10), width_bucket('-Infinity'::float8, 1, 10, 10);
 ...
 SELECT x, width_bucket(x::float8, 100, 10, 9) as flt, width_bucket(x::numeric, 100, 10, 9) as num FROM generate_series(0, 110, 10) x;
  ...
  SELECT to_char(val, '9G999G999G999G999G999D999G999G999G999G999') FROM num_data;
  SELECT to_char(val, '9999999999999999.999999999999999PR') FROM num_data;
  SELECT to_char(val, '9999999999999999.999999999999999S') FROM num_data;
 ...
 -- should be true select min_scale(numeric 'inf') is NULL;
 -- should be true select min_scale(0);
               ...
               -- scale 5, 2 NDIGITS select min_scale(1.1000);
                -- 1 pos in NDIGITS select min_scale(1e100);
                 -- very big number   select trim_scale(numeric 'NaN');
