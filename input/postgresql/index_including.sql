/* * 1.test CREATE INDEX * * Deliberately avoid dropping objects in this section, to get some pg_dump * coverage. */  CREATE TABLE tbl_include_reg (c1 int, c2 int, c3 int, c4 box);
 ...
 \d tbl_include_reg_idx  CREATE TABLE tbl_include_unique1 (c1 int, c2 int, c3 int, c4 box);
 ...
 SELECT indexdef FROM pg_indexes WHERE tablename = 'tbl' ORDER BY indexname;
 DROP TABLE tbl;
  /* * 7. Check various AMs. All but btree, gist and spgist must fail. */ CREATE TABLE tbl (c1 int,c2 int, c3 box, c4 box);
