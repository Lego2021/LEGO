SET DateStyle = 'Postgres, MDY';
  SHOW TimeZone;
  -- Many of these tests depend on the prevailing setting  SELECT timestamp with time zone '20011227 040506+08';
 ...
 SELECT time with time zone '02:30-08' + interval '36:01' AS "14:31:00-08";
  ...
  SELECT d.f1 AS "timestamp", t.f1 AS "interval", d.f1 + t.f1 AS plus FROM TEMP_TIMESTAMP d, INTERVAL_TBL t ORDER BY plus, "timestamp", "interval";
  SELECT d.f1 AS "timestamp", t.f1 AS "interval", d.f1 - t.f1 AS minus FROM TEMP_TIMESTAMP d, INTERVAL_TBL t WHERE isfinite(d.f1) ORDER BY minus, "timestamp", "interval";
  ...
  SELECT d1.f1 AS timestamp1, d2.f1 AS timestamp2, d1.f1 - d2.f1 AS difference FROM TEMP_TIMESTAMP d1, TEMP_TIMESTAMP d2 ORDER BY timestamp1, timestamp2, difference;
 ...
 SELECT to_timestamp('2011-12-18 11:38 20',     'YYYY-MM-DD HH12:MI TZM');
  ...
  -- NYI  SELECT to_timestamp('2018-11-02 12:34:56.025', 'YYYY-MM-DD HH24:MI:SS.MS');
 ...
 SELECT i, to_timestamp('2018-11-02 12:34:56.123456789', 'YYYY-MM-DD HH24:MI:SS.FF' || i) FROM generate_series(1, 6) i;
  ...
  -- Q is ignored SELECT to_date('3 4 21 01', 'W MM CC YY');
 ...
 SELECT to_timestamp('Fri 1-Jan-1999', 'DY DD MON YYYY');
  -- ok  SELECT to_timestamp('1997-11-Jan-16', 'YYYY-MM-Mon-DD');
 ...
 SELECT to_timestamp('2016-06-13 15:50:55', 'YYYY-MM-DD HH24:MI:SS');
  -- ok SELECT to_timestamp('2016-06-13 15:50:55', 'YYYY-MM-DD HH:MI:SS');
 ...
 SELECT to_timestamp('2016-02-29 15:50:55', 'YYYY-MM-DD HH24:MI:SS');
  -- ok SELECT to_timestamp('2015-02-29 15:50:55', 'YYYY-MM-DD HH24:MI:SS');
 SELECT to_timestamp('2015-02-11 86000', 'YYYY-MM-DD SSSS');
  -- ok SELECT to_timestamp('2015-02-11 86400', 'YYYY-MM-DD SSSS');
 SELECT to_timestamp('2015-02-11 86000', 'YYYY-MM-DD SSSSS');
  -- ok SELECT to_timestamp('2015-02-11 86400', 'YYYY-MM-DD SSSSS');
 SELECT to_date('2016-13-10', 'YYYY-MM-DD');
 SELECT to_date('2016-02-30', 'YYYY-MM-DD');
 SELECT to_date('2016-02-29', 'YYYY-MM-DD');
  -- ok SELECT to_date('2015-02-29', 'YYYY-MM-DD');
 SELECT to_date('2015 365', 'YYYY DDD');
  -- ok SELECT to_date('2015 366', 'YYYY DDD');
 SELECT to_date('2016 365', 'YYYY DDD');
  -- ok SELECT to_date('2016 366', 'YYYY DDD');
  -- ok SELECT to_date('2016 367', 'YYYY DDD');
 SELECT to_date('0000-02-01','YYYY-MM-DD');
  -- allowed, though it shouldn't be   SET TIME ZONE 'America/New_York';
 SET TIME ZONE '-1.5';
  SHOW TIME ZONE;
