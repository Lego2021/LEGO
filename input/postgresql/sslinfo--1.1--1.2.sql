/* contrib/sslinfo/sslinfo--1.1--1.2.sql */  \echo Use "ALTER EXTENSION sslinfo UPDATE TO '1.2'" to load this file. \quit  ALTER FUNCTION ssl_client_serial() PARALLEL RESTRICTED;
