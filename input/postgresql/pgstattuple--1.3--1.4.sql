/* contrib/pgstattuple/pgstattuple--1.3--1.4.sql */  \echo Use "ALTER EXTENSION pgstattuple UPDATE TO '1.4'" to load this file. \quit  ALTER FUNCTION pgstattuple(text) PARALLEL SAFE;
