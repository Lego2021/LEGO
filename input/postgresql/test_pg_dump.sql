CREATE ROLE regress_dump_test_role;
 ...
 -- error  CREATE TABLE test_pg_dump_t1 (c1 int, junk text);
 ALTER TABLE test_pg_dump_t1 DROP COLUMN junk;
  -- to exercise dropped-col cases CREATE VIEW test_pg_dump_v1 AS SELECT * FROM test_pg_dump_t1;
 ...
 CREATE TYPE test_pg_dump_e1 AS ENUM ('abc', 'def');
  ...
  CREATE FUNCTION test_pg_dump(int) RETURNS int AS $$ BEGIN RETURN abs($1);
