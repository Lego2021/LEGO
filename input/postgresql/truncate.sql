CREATE TABLE truncate_a (col1 integer primary key);
 ...
 CREATE TABLE trunc_e (a int REFERENCES truncate_a, b int REFERENCES trunc_c);
  TRUNCATE TABLE truncate_a;
        -- fail TRUNCATE TABLE truncate_a,trunc_b;
        -- fail TRUNCATE TABLE truncate_a,trunc_b,trunc_e;
    -- ok TRUNCATE TABLE truncate_a,trunc_e;
        -- fail TRUNCATE TABLE trunc_c;
        -- fail TRUNCATE TABLE trunc_c,trunc_d;
        -- fail TRUNCATE TABLE trunc_c,trunc_d,trunc_e;
    -- ok TRUNCATE TABLE trunc_c,trunc_d,trunc_e,truncate_a;
    -- fail TRUNCATE TABLE trunc_c,trunc_d,trunc_e,truncate_a,trunc_b;
    -- ok  TRUNCATE TABLE truncate_a RESTRICT;
 -- fail TRUNCATE TABLE truncate_a CASCADE;
  -- ok  ALTER TABLE truncate_a ADD FOREIGN KEY (col1) REFERENCES trunc_c;
 ...
 INSERT INTO trunc_e VALUES (1,1);
  ...
  -- ok  SELECT * FROM truncate_a UNION ALL SELECT * FROM trunc_c UNION ALL SELECT * FROM trunc_b UNION ALL SELECT * FROM trunc_d;
 SELECT * FROM trunc_e;
 ...
 -- fail, seq should have been dropped  CREATE TABLE truncparted (a int, b char) PARTITION BY LIST (a);
 ...
 CREATE TABLE trunc_a2 PARTITION OF trunc_a FOR VALUES FROM (10) TO (20) PARTITION BY RANGE (a);
 ...
 SELECT a FROM ref_b;
  DROP TABLE ref_b;
  CREATE TABLE ref_c ( c INT PRIMARY KEY, a INT REFERENCES trunc_a(a) ON DELETE CASCADE ) PARTITION BY RANGE (c);
