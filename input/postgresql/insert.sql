create table inserttest (col1 int4, col2 int4 NOT NULL, col3 text default 'testing');
 ...
 insert into inserttest (f2[1], f2[2]) values (1,default);
  -- not supported  insert into inserttest (f3.if1, f3.if2) values (1,array['foo']);
 insert into inserttest (f3.if1, f3.if2) values (1,'{foo}'), (2,'{bar}');
 insert into inserttest (f3.if1, f3.if2) select 3, '{baz,quux}';
 insert into inserttest (f3.if1, f3.if2) values (1,default);
  -- not supported  insert into inserttest (f3.if2[1], f3.if2[2]) values ('foo', 'bar');
 ...
 \d+ inserttest2  drop table inserttest2;
 drop table inserttest;
 ...
 insert into hpart3 values(11);
  ...
  \d+ list_parted  drop table range_parted, list_parted;
 drop table hash_parted;
  create table list_parted (a int) partition by list (a);
 create table part_default partition of list_parted default;
 \d+ part_default insert into part_default values (null);
 ...
 insert into mlparted values (1, 40, 'a', 1);
  -- goes to mlparted5_a insert into mlparted values (1, 45, 'b', 1);
  -- goes to mlparted5_b insert into mlparted values (1, 45, 'c', 1);
  -- goes to mlparted5_cd, fails insert into mlparted values (1, 45, 'f', 1);
  -- goes to mlparted5, fails select tableoid::regclass, * from mlparted order by a, b, c, d;
 ...
 insert into mcrparted4 values (30, 21, 20);
    -- error  select tableoid::regclass::text, * from mcrparted order by 1;
 ...
 create table mcrparted8_ge_d partition of mcrparted for values from ('d', minvalue) to (maxvalue, maxvalue);
  \d+ mcrparted \d+ mcrparted1_lt_b \d+ mcrparted2_b \d+ mcrparted3_c_to_common \d+ mcrparted4_common_lt_0 \d+ mcrparted5_common_0_to_10 \d+ mcrparted6_common_ge_10 \d+ mcrparted7_gt_common_lt_d \d+ mcrparted8_ge_d  insert into mcrparted values ('aaa', 0), ('b', 0), ('bz', 10), ('c', -10), ('comm', -10), ('common', -10), ('common', 0), ('common', 10), ('commons', 0), ('d', -10), ('e', 0);
