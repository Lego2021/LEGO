 ...
 select polyf(point(3,4));
  -- fail for lack of + operator  drop function polyf(x anyelement);
  ...
  -- fail, can't infer element type  drop function polyf(x anyarray);
  ...
  -- range type doesn't fit  drop function polyf(x anycompatiblerange, y anycompatible, z anycompatible);
  ...
  -- range type doesn't fit  drop function polyf(x anycompatiblemultirange, y anycompatible, z anycompatible);
 ...
 select x, pg_typeof(x), y, pg_typeof(y) from polyf(11, array[1, 2.2], 42, 34.5);
  -- fail  drop function polyf(a anyelement, b anyarray, c anycompatible, d anycompatible);
 ...
 select myleast();
 -- fail  select myleast(variadic array[1,2,3,4,-1]);
 ...
 -- fail without variadic select formarray(1, 'x'::text);
 -- fail, type mismatch select formarray(1, variadic array['x'::text]);
 -- fail, type mismatch  drop function formarray(anyelement, variadic anyarray);
 ...
 -- numeric[] select pg_typeof(myleast(10, 1, 20, 33));
  -- polymorphic input   create function dfunc(a int = 1, int = 2) returns int as $$ select $1 + $2;
 $$ language sql;
  select dfunc();
 select dfunc(10);
 select dfunc(10, 20);
 select dfunc(10, 20, 30);
  -- fail  drop function dfunc();
  -- fail drop function dfunc(int);
  -- fail drop function dfunc(int, int);
  -- ok  create function dfunc(a int = 1, b int) returns int as $$ select $1 + $2;
 $$ language sql;
  create function dfunc(a int = 1, out sum int, b int = 2) as $$ select $1 + $2;
 $$ language sql;
  select dfunc();
  \df dfunc  drop function dfunc(int, int);
 ...
 $$ language sql;
  ...
  -- ok  drop function dfunc(int, int);
 ...
 select dfunc(10,20);
  ...
  \df dfunc  drop function dfunc(a variadic int[]);
 ...
 select * from dfunc(0);
  -- fail select * from dfunc(1,2);
 select * from dfunc(1,2,c := 3);
 select * from dfunc(1,2,d := 3);
  select * from dfunc(x := 20, b := 10, x := 30);
  -- fail, duplicate name select * from dfunc(10, b := 20, 30);
  -- fail, named args must be last select * from dfunc(x := 10, b := 20, c := 30);
  -- fail, unknown param select * from dfunc(10, 10, a := 20);
  -- fail, a overlaps positional parameter select * from dfunc(1,c := 2,d := 3);
 -- fail, no value for b  drop function dfunc(int, int, int, int);
 ...
 select * from dfunc('Hello World', c := 20, b := '2009-07-25'::date);
  -- fail  drop function dfunc(varchar, numeric, date);
...
$$ language sql;
 ...
 -- positional notation with default  select dfunc(a := 1, b := 2);
 select dfunc(a := 'a'::text, b := 'b');
 select dfunc(a := 'a'::text, b := 'b', flag := false);
 -- named notation  select dfunc(b := 'b'::text, a := 'a');
 -- named notation with default select dfunc(a := 'a'::text, flag := true);
 -- named notation with default select dfunc(a := 'a'::text, flag := false);
 -- named notation with default select dfunc(b := 'b'::text, a := 'a', flag := true);
 -- named notation  select dfunc('a'::text, 'b', false);
 -- full positional notation select dfunc('a'::text, 'b', flag := false);
 -- mixed notation select dfunc('a'::text, 'b', true);
 -- full positional notation select dfunc('a'::text, 'b', flag := true);
 -- mixed notation  select dfunc(a => 1, b => 2);
 select dfunc(a => 'a'::text, b => 'b');
 select dfunc(a => 'a'::text, b => 'b', flag => false);
 -- named notation  select dfunc(b => 'b'::text, a => 'a');
 -- named notation with default select dfunc(a => 'a'::text, flag => true);
 ...
 -- mixed notation select dfunc('a'::text, 'b', true);
 -- full positional notation select dfunc('a'::text, 'b', flag => true);
 -- mixed notation  select dfunc(a =>-1);
 select dfunc(a =>+1);
 select dfunc(a =>/**/1);
 ...
 select x, pg_typeof(x) from anyctest(11, point(1,2)) x;
  -- fail select x, pg_typeof(x) from anyctest('11', '12.3') x;
  -- defaults to text  drop function anyctest(anycompatible, anycompatible);
 ...
 select x, pg_typeof(x) from anyctest(11, array[1,2]) x;
  -- fail  drop function anyctest(anycompatible, anycompatible);
 ...
 select x, pg_typeof(x) from anyctest(11, array[point(1,2)]) x;
  -- fail select x, pg_typeof(x) from anyctest(11, 12) x;
  -- fail  drop function anyctest(anycompatible, anycompatiblearray);
 ...
 select x, pg_typeof(x) from anyctest(11, 12) x;
  -- fail select x, pg_typeof(x) from anyctest(11.2, int4range(4,7)) x;
  -- fail select x, pg_typeof(x) from anyctest(11.2, '[4,7)') x;
  -- fail  drop function anyctest(anycompatible, anycompatiblerange);
 ...
 -- fail  drop function anyctest(anycompatiblerange, anycompatiblerange);
 ...
 select x, pg_typeof(x) from anyctest(11, 12) x;
  -- fail select x, pg_typeof(x) from anyctest(11.2, multirange(int4range(4,7))) x;
  -- fail select x, pg_typeof(x) from anyctest(11.2, '{[4,7)}') x;
  -- fail  drop function anyctest(anycompatible, anycompatiblemultirange);
 ...
 -- fail  drop function anyctest(anycompatiblemultirange, anycompatiblemultirange);
 ...
 select x, pg_typeof(x) from anyctest(array[11], array[1,2]) x;
  -- fail  drop function anyctest(anycompatiblenonarray, anycompatiblenonarray);
 ...
 select x, pg_typeof(x) from anyctest(11, array[1, 2.2], 42, 34.5) x;
  -- fail  drop function anyctest(a anyelement, b anyarray, c anycompatible, d anycompatible);
 ...
 select x, pg_typeof(x) from anyctest(11, '12') x;
 select x, pg_typeof(x) from anyctest(11, '12.2') x;
  -- fail select x, pg_typeof(x) from anyctest(variadic array[11, 12]) x;
