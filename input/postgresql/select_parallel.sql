 create function sp_parallel_restricted(int) returns int as $$begin return $1;
 ...
 EXCEPTION WHEN invalid_parameter_value THEN END $$;
 set work_mem='64kB';
 ...
 alter table tenk2 reset (parallel_workers);
  reset work_mem;
 create function explain_parallel_sort_stats() returns setof text language plpgsql as $$ declare ln text;
 ...
 reset enable_nestloop;
  ...
  create function sp_simple_func(var1 integer) returns integer as $$ begin return var1 + 10;
 end;
