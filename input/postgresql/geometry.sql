 SET extra_float_digits TO -3;
  ...
  SELECT p1.f1 FROM POINT_TBL p1 WHERE p1.f1 ?- point '(0,0)';
  SELECT p1.f1 FROM POINT_TBL p1 WHERE isvertical(p1.f1, point '(5.1,34.5)');
  SELECT p1.f1 FROM POINT_TBL p1 WHERE p1.f1 ?| point '(5.1,34.5)';
 ...
 SELECT l.s, b.f1, b.f1 <-> l.s FROM LINE_TBL l, BOX_TBL b;
  ...
  SELECT b.f1 + p.f1 AS translation FROM BOX_TBL b, POINT_TBL p;
  SELECT b.f1 - p.f1 AS translation FROM BOX_TBL b, POINT_TBL p;
  ...
  SELECT p1.f1, p2.f1, p1.f1 <-> p2.f1 FROM PATH_TBL p1, PATH_TBL p2;
   SELECT p.f1, poly.f1, poly.f1 @> p.f1 AS contains FROM POLYGON_TBL poly, POINT_TBL p;
  SELECT p.f1, poly.f1, p.f1 <@ poly.f1 AS contained FROM POLYGON_TBL poly, POINT_TBL p;
