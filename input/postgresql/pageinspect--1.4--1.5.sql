/* contrib/pageinspect/pageinspect--1.4--1.5.sql */  \echo Use "ALTER EXTENSION pageinspect UPDATE TO '1.5'" to load this file. \quit  ALTER FUNCTION get_raw_page(text, int4) PARALLEL SAFE;
