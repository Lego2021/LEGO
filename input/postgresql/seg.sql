 ...
 SELECT '1'::seg <@ '-1 .. 1'::seg AS bool;
  ...
  \copy test_seg from 'data/test_seg.data'  CREATE INDEX test_seg_ix ON test_seg USING gist (s);
  EXPLAIN (COSTS OFF) SELECT count(*) FROM test_seg WHERE s @> '11..11.3';
 ...
 RESET enable_bitmapscan;
  ...
  SELECT seg_lower(s), seg_center(s), seg_upper(s) FROM test_seg WHERE s @> '11.2..11.3' OR s IS NULL ORDER BY s;
