 SET extra_float_digits = 0;
  ...
  INSERT INTO POINT_TBL(f1) VALUES ('(1e-300,-1e-300)');
    -- To underflow  INSERT INTO POINT_TBL(f1) VALUES ('(1e+300,Inf)');
        -- To overflow  INSERT INTO POINT_TBL(f1) VALUES ('(Inf,1e+300)');
        -- Transposed  INSERT INTO POINT_TBL(f1) VALUES (' ( Nan , NaN ) ');
  ...
  INSERT INTO POINT_TBL(f1) VALUES ('(10.0, 1e+500)');
    -- Out of range   SELECT * FROM POINT_TBL;
  ...
  SELECT p.* FROM POINT_TBL p WHERE p.f1 <@ box '(0,0,100,100)';
  SELECT p.* FROM POINT_TBL p WHERE box '(0,0,100,100)' @> p.f1;
  SELECT p.* FROM POINT_TBL p WHERE not p.f1 <@ box '(0,0,100,100)';
  SELECT p.* FROM POINT_TBL p WHERE p.f1 <@ path '[(0,0),(-10,0),(-10,10)]';
  ...
  SELECT p1.f1 AS point1, p2.f1 AS point2 FROM POINT_TBL p1, POINT_TBL p2 WHERE (p1.f1 <-> p2.f1) > 3;
