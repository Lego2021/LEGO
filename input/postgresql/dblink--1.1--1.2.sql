/* contrib/dblink/dblink--1.1--1.2.sql */  \echo Use "ALTER EXTENSION dblink UPDATE TO '1.2'" to load this file. \quit  ALTER FUNCTION dblink_connect(text) PARALLEL RESTRICTED;
