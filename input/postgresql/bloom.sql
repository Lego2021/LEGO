CREATE EXTENSION bloom;
 ...
 SELECT count(*) FROM tst WHERE t = '5';
 SELECT count(*) FROM tst WHERE i = 7 AND t = '5';
   CREATE UNLOGGED TABLE tstu ( i    int4, t    text );
 ...
 RESET enable_indexscan;
  SELECT opcname, amvalidate(opc.oid) FROM pg_opclass opc JOIN pg_am am ON am.oid = opcmethod WHERE amname = 'bloom' ORDER BY 1;
  DROP INDEX bloomidx;
 ...
 \set VERBOSITY terse CREATE INDEX bloomidx2 ON tst USING bloom (i, t) WITH (length=0);
