SELECT attrelid, attname, attidentity FROM pg_attribute WHERE attidentity NOT IN ('', 'a', 'd');
 ...
 ALTER TABLE itest3 ALTER COLUMN a ADD GENERATED ALWAYS AS IDENTITY;
  -- error  SELECT table_name, column_name, column_default, is_nullable, is_identity, identity_generation, identity_start, identity_increment, identity_maximum, identity_minimum, identity_cycle FROM information_schema.columns WHERE table_name LIKE 'itest_' ORDER BY 1, 2;
  SELECT sequence_name FROM information_schema.sequences WHERE sequence_name LIKE 'itest%';
  SELECT pg_get_serial_sequence('itest1', 'a');
  \d itest1_a_seq  CREATE TABLE itest4 (a int, b text);
 ALTER TABLE itest4 ALTER COLUMN a ADD GENERATED ALWAYS AS IDENTITY;
  -- error, requires NOT NULL ALTER TABLE itest4 ALTER COLUMN a SET NOT NULL;
 ALTER TABLE itest4 ALTER COLUMN a ADD GENERATED ALWAYS AS IDENTITY;
  -- ok ALTER TABLE itest4 ALTER COLUMN a DROP NOT NULL;
  ...
  -- error, wrong data type  ALTER TABLE itest4 ALTER COLUMN b SET DEFAULT '';
 ...
 INSERT INTO itest5 VALUES (1, 'a');
  -- error INSERT INTO itest5 VALUES (DEFAULT, 'a');
  -- ok INSERT INTO itest5 VALUES (2, 'b'), (3, 'c');
  -- error INSERT INTO itest5 VALUES (DEFAULT, 'b'), (3, 'c');
  -- error INSERT INTO itest5 VALUES (2, 'b'), (DEFAULT, 'c');
  -- error INSERT INTO itest5 VALUES (DEFAULT, 'b'), (DEFAULT, 'c');
  -- ok  INSERT INTO itest5 OVERRIDING SYSTEM VALUE VALUES (-1, 'aa');
 ...
 SELECT * FROM itest1;
  ...
  -- error UPDATE itest2 SET a = DEFAULT WHERE a = 2;
  -- ok SELECT * FROM itest2;
 ...
 ALTER TABLE itest4 ALTER COLUMN a DROP IDENTITY;
  ...
  -- noop  INSERT INTO itest4 DEFAULT VALUES;
  -- fails because NOT NULL is not dropped ALTER TABLE itest4 ALTER COLUMN a DROP NOT NULL;
 INSERT INTO itest4 DEFAULT VALUES;
 SELECT * FROM itest4;
 ...
 \d itest3  ALTER TABLE itest3 ALTER COLUMN a TYPE text;
  -- error  ALTER TABLE itest3 ADD COLUMN c int GENERATED BY DEFAULT AS IDENTITY, ALTER COLUMN c SET GENERATED ALWAYS;
 \d itest3    CREATE TABLE itest6 (a int GENERATED ALWAYS AS IDENTITY, b text);
 ...
 SELECT * FROM itest6;
  ...
  -- fail, not identity    ALTER SEQUENCE itest6_a_seq OWNED BY NONE;
 ...
 ALTER TABLE itest7d ADD COLUMN b int GENERATED ALWAYS AS IDENTITY;
  -- error  SELECT table_name, column_name, is_nullable, is_identity, identity_generation FROM information_schema.columns WHERE table_name LIKE 'itest7%' ORDER BY 1, 2;
 ...
 DROP USER regress_identity_user1;
  ...
  ALTER TABLE itest8 ADD COLUMN f4 int;
  ...
  ALTER TABLE itest8 ADD COLUMN f5 int GENERATED ALWAYS AS IDENTITY;
  ...
  ALTER TABLE itest8 ADD COLUMN f22 int NOT NULL, ALTER COLUMN f22 ADD GENERATED ALWAYS AS IDENTITY;
  TABLE itest8;
 \d+ itest8 \d itest8_f2_seq \d itest8_f3_seq \d itest8_f4_seq \d itest8_f5_seq DROP TABLE itest8;
 ...
 CREATE TABLE itest_child PARTITION OF itest_parent ( f3 WITH OPTIONS GENERATED ALWAYS AS IDENTITY ) FOR VALUES FROM ('2016-07-01') TO ('2016-08-01');
 -- error DROP TABLE itest_parent;
 ...
 -- fail CREATE TABLE itest15 (id integer NULL GENERATED ALWAYS AS IDENTITY);
 -- fail CREATE TABLE itest15 (id integer GENERATED ALWAYS AS IDENTITY NOT NULL);
 DROP TABLE itest15;
