 ...
 INSERT INTO FKTABLE VALUES(42);
        -- should succeed INSERT INTO FKTABLE VALUES(43);
        -- should fail UPDATE FKTABLE SET ftest1 = ftest1;
    -- should succeed UPDATE FKTABLE SET ftest1 = ftest1 + 1;
    -- should fail DROP TABLE FKTABLE;
 ...
 -- make the FK insert valid  COMMIT;
 ...
 -- fail alter table defc alter column f1 set default 1;
 delete from defp where f1 = 0;
 select * from defc;
 delete from defp where f1 = 1;
 -- fail  create temp table pp (f1 int primary key);
 ...
 update pp set f1=f1+1;
 update pp set f1=f1+1;
 -- fail delete from pp where f1 = 13;
 -- fail drop table pp, cc;
 ...
 \d fk_notpartitioned_pk ALTER TABLE fk_partitioned_fk DROP CONSTRAINT fk_partitioned_fk_a_b_fkey;
 ...
 ALTER TABLE fk_partitioned_fk_full ADD FOREIGN KEY (x, y) REFERENCES fk_notpartitioned_pk MATCH FULL;
  -- fails TRUNCATE fk_partitioned_fk_full;
 ALTER TABLE fk_partitioned_fk_full ADD FOREIGN KEY (x, y) REFERENCES fk_notpartitioned_pk MATCH FULL;
 INSERT INTO fk_partitioned_fk_full VALUES (1, NULL);
  -- fails DROP TABLE fk_partitioned_fk_full;
 ...
 ALTER TABLE fk_partitioned_fk ATTACH PARTITION fk_partitioned_fk_2 FOR VALUES IN (1500,1502);
 \d fk_partitioned_fk_2 DROP TABLE fk_partitioned_fk_2;
 ...
 ALTER TABLE fk_partitioned_fk ATTACH PARTITION fk_partitioned_fk_4 FOR VALUES IN (3500,3502);
 \d fk_partitioned_fk_4 \d fk_partitioned_fk_4_1 \d fk_partitioned_fk_4_2  CREATE TABLE fk_partitioned_fk_5 (a int, b int, FOREIGN KEY (a, b) REFERENCES fk_notpartitioned_pk(a, b) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE, FOREIGN KEY (a, b) REFERENCES fk_notpartitioned_pk(a, b) MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE) PARTITION BY RANGE (a);
 ...
 ALTER TABLE fk_partitioned_fk ATTACH PARTITION fk_partitioned_fk_5 FOR VALUES IN (4500);
 \d fk_partitioned_fk_5 ALTER TABLE fk_partitioned_fk_5 DETACH PARTITION fk_partitioned_fk_5_1;
 ALTER TABLE fk_partitioned_fk_5 ATTACH PARTITION fk_partitioned_fk_5_1 FOR VALUES FROM (0) TO (10);
 \d fk_partitioned_fk_5_1  CREATE TABLE fk_partitioned_fk_2 (a int, b int) PARTITION BY RANGE (b);
 ...
 \d fkpart0.fk_part_1    \\ -- should have only one FK alter table fkpart0.fk_part_1 drop constraint fk_part_1_a_fkey;
  \d fkpart0.fk_part_23    \\ -- should have only one FK \d fkpart0.fk_part_23_2    \\ -- should have only one FK alter table fkpart0.fk_part_23 drop constraint fk_part_23_a_fkey;
 ...
 \d fkpart0.fk_part_4 alter table fkpart0.fk_part_4 drop constraint fk_part_a_fkey;
 ...
 \d fkpart0.fk_part_56 alter table fkpart0.fk_part_56 drop constraint fk_part_a_fkey;
 ...
 insert into fkpart1.fk_part values (1);
        -- should fail insert into fkpart1.pkey values (1);
 insert into fkpart1.fk_part values (1);
 ...
 insert into fkpart1.fk_part_1 values (2);
    -- should fail delete from fkpart1.pkey where a = 1;
 ...
 COMMIT;
                            -- OK  CREATE TABLE pt(f1 int, f2 int, f3 int, PRIMARY KEY(f1,f2));
 CREATE TABLE ref(f1 int, f2 int, f3 int) PARTITION BY list(f1);
 ...
 ABORT;
 DROP TABLE pt, ref;
  CREATE TABLE pt(f1 int, f2 int, f3 int, PRIMARY KEY(f1,f2)) PARTITION BY LIST(f1);
 ...
 DROP SCHEMA fkpart8 CASCADE;
  CREATE SCHEMA fkpart9 CREATE TABLE pk (a INT PRIMARY KEY) PARTITION BY RANGE (a) CREATE TABLE fk ( fk_a INT REFERENCES pk(a) ON DELETE CASCADE ) CREATE TABLE pk1 PARTITION OF pk FOR VALUES FROM (30) TO (50) PARTITION BY RANGE (a) CREATE TABLE pk11 PARTITION OF pk1 FOR VALUES FROM (30) TO (40);
 ...
 DROP SCHEMA fkpart9 CASCADE;
  CREATE SCHEMA fkpart10 CREATE TABLE tbl1(f1 int PRIMARY KEY) PARTITION BY RANGE(f1) CREATE TABLE tbl1_p1 PARTITION OF tbl1 FOR VALUES FROM (minvalue) TO (1) CREATE TABLE tbl1_p2 PARTITION OF tbl1 FOR VALUES FROM (1) TO (maxvalue) CREATE TABLE tbl2(f1 int REFERENCES tbl1 DEFERRABLE INITIALLY DEFERRED);
