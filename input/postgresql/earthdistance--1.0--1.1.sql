/* contrib/earthdistance/earthdistance--1.0--1.1.sql */  \echo Use "ALTER EXTENSION earthdistance UPDATE TO '1.1'" to load this file. \quit  ALTER FUNCTION earth() PARALLEL SAFE;
