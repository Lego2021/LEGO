 ...
 CREATE SEQUENCE sequence_testx CACHE 0;
  ...
  -- nonsense word CREATE SEQUENCE sequence_testx OWNED BY pg_class_oid_index.oid;
  -- not a table CREATE SEQUENCE sequence_testx OWNED BY pg_class.relname;
  -- not same schema CREATE TABLE sequence_test_table (a int);
 CREATE SEQUENCE sequence_testx OWNED BY sequence_test_table.b;
  -- wrong column DROP TABLE sequence_test_table;
 ...
 CREATE SEQUENCE sequence_testx AS smallint MINVALUE -100000;
  ...
  -- min and max will be adjusted   CREATE TABLE serialTest1 (f1 text, f2 serial);
 ...
 DROP SEQUENCE myseq2;
  ...
  -- error, not a sequence  CREATE SEQUENCE sequence_test2 START WITH 32;
 ...
 SELECT nextval('sequence_test2');
  ...
  -- error  ALTER SEQUENCE sequence_test2 RESTART WITH 24 INCREMENT BY 4 MAXVALUE 36 MINVALUE 5 CYCLE;
 SELECT nextval('sequence_test2');
 SELECT nextval('sequence_test2');
 SELECT nextval('sequence_test2');
 SELECT nextval('sequence_test2');
 ...
 SELECT nextval('sequence_test2');
 SELECT nextval('sequence_test2');
  -- error  ALTER SEQUENCE IF EXISTS sequence_test2 RESTART WITH 32 START WITH 32 INCREMENT BY 4 MAXVALUE 36 MINVALUE 5 CYCLE;
  ...
  -- not read from, to test is_called   SELECT * FROM information_schema.sequences WHERE sequence_name ~ ANY(ARRAY['sequence_test', 'serialtest']) ORDER BY sequence_name ASC;
  SELECT schemaname, sequencename, start_value, min_value, max_value, increment_by, cycle, cache_size, last_value FROM pg_sequences WHERE sequencename ~ ANY(ARRAY['sequence_test', 'serialtest']) ORDER BY sequencename ASC;
   SELECT * FROM pg_sequence_parameters('sequence_test4'::regclass);
   \d sequence_test4 \d serialtest2_f2_seq   COMMENT ON SEQUENCE asdf IS 'won''t work';
