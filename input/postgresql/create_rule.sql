  CREATE RULE rule_1 AS ON INSERT TO datatype_table DO NOTHING;
  ...
  CREATE RULE "_RETURN" AS ON SELECT TO like_datatype_table DO INSTEAD SELECT * FROM datatype_view;
