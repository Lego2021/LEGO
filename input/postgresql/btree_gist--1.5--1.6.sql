/* contrib/btree_gist/btree_gist--1.5--1.6.sql */  \echo Use "ALTER EXTENSION btree_gist UPDATE TO '1.6'" to load this file. \quit   ALTER FUNCTION gbtreekey4_in(cstring) PARALLEL SAFE;
