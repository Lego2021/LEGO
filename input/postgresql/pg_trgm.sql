CREATE EXTENSION pg_trgm;
 ...
 select similarity('wow',' WOW ');
  ...
  \copy test_trgm from 'data/trgm.data'  select t,similarity(t,'qwertyu0988') as sml from test_trgm where t % 'qwertyu0988' order by sml desc, t;
 ...
 select t,similarity(t,'gwertyu0988') as sml from test_trgm where t % 'gwertyu0988' order by sml desc, t;
 select t,similarity(t,'gwertyu1988') as sml from test_trgm where t % 'gwertyu1988' order by sml desc, t;
 explain (costs off) select t <-> 'q0987wertyu0988', t from test_trgm order by t <-> 'q0987wertyu0988' limit 2;
 select t <-> 'q0987wertyu0988', t from test_trgm order by t <-> 'q0987wertyu0988' limit 2;
 select count(*) from test_trgm where t ~ '[qwerty]{2}-?[qwerty]{2}';
  drop index trgm_idx;
 ...
 select t,similarity(t,'gwertyu1988') as sml from test_trgm where t % 'gwertyu1988' order by sml desc, t;
 select count(*) from test_trgm where t ~ '[qwerty]{2}-?[qwerty]{2}';
  explain (costs off) select count(*) from test_trgm where t like '%99%' and t like '%qwerty%';
 select count(*) from test_trgm where t like '%99%' and t like '%qwerty%';
 explain (costs off) select count(*) from test_trgm where t like '%99%' and t like '%qw%';
 ...
 explain (costs off) select count(*) from t_test_trgm where t like '%99%' and t like '%qwerty%';
 select count(*) from t_test_trgm where t like '%99%' and t like '%qwerty%';
 explain (costs off) select count(*) from t_test_trgm where t like '%99%' and t like '%qw%';
 ...
 set enable_seqscan=off;
 explain (costs off) select * from test2 where t like '%BCD%';
 explain (costs off) select * from test2 where t ilike '%BCD%';
 ...
 explain (costs off) select * from test2 where t ~ '[abc]{3}';
 explain (costs off) select * from test2 where t ~* 'DEF';
 ...
 explain (costs off) select * from test2 where t = 'abcdef';
 select * from test2 where t = 'abcdef';
 explain (costs off) select * from test2 where t = '%line%';
 ...
 CREATE INDEX ON restaurants USING gist(city gist_trgm_ops);
  ...
  EXPLAIN (COSTS OFF) SELECT DISTINCT city, similarity(city, 'Warsaw'), show_limit() FROM restaurants WHERE city % 'Warsaw';
 SELECT set_limit(0.3);
 SELECT DISTINCT city, similarity(city, 'Warsaw'), show_limit() FROM restaurants WHERE city % 'Warsaw';
