 ...
 \z deptest1 \d deptest  GRANT ALL ON deptest1 TO regress_dep_user1;
 ...
 \dt deptest  SELECT typowner = relowner FROM pg_type JOIN pg_class c ON typrelid = c.oid WHERE typname = 'deptest_t';
