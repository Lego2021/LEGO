/* contrib/pg_visibility/pg_visibility--1.0--1.1.sql */  \echo Use "ALTER EXTENSION pg_visibility UPDATE TO '1.1'" to load this file. \quit  CREATE FUNCTION pg_check_frozen(regclass, t_ctid OUT tid) RETURNS SETOF tid AS 'MODULE_PATHNAME', 'pg_check_frozen' LANGUAGE C STRICT;
  ...
  -- let's not make this any more dangerous  REVOKE ALL ON FUNCTION pg_check_frozen(regclass) FROM PUBLIC;
