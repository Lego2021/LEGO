/* contrib/pgcrypto/pgcrypto--1.2--1.3.sql */  \echo Use "ALTER EXTENSION pgcrypto UPDATE TO '1.3'" to load this file. \quit  ALTER FUNCTION digest(text, text) PARALLEL SAFE;
