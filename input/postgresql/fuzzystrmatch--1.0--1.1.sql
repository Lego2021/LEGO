/* contrib/fuzzystrmatch/fuzzystrmatch--1.0--1.1.sql */  \echo Use "ALTER EXTENSION fuzzystrmatch UPDATE TO '1.1'" to load this file. \quit  ALTER FUNCTION levenshtein(text, text) PARALLEL SAFE;
