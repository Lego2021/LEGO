 ...
 SELECT pg_get_viewdef('vsubdepartment'::regclass, true);
  ...
  \d+ sums_1_100  with recursive q as ( select * from department union all (with x as (select * from q) select * from x) ) select * from q limit 24;
 ...
 DROP RULE y_rule ON y;
  ...
  -- fail, WITH is a reserved word create table foo (with ordinality);
  -- fail, WITH is a reserved word with ordinality as (select 1 as x) select * from ordinality;
