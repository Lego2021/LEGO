CREATE EXTENSION ltree;
 ...
 \copy ltreetest FROM 'data/ltree.data'  SELECT * FROM ltreetest WHERE t <  '12.3' order by t asc;
 ...
 \copy _ltreetest FROM 'data/_ltree.data'  SELECT count(*) FROM _ltreetest WHERE t @> '1.1.1' ;
