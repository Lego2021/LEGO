/* contrib/unaccent/unaccent--1.0--1.1.sql */  \echo Use "ALTER EXTENSION unaccent UPDATE TO '1.1'" to load this file. \quit  ALTER FUNCTION unaccent(regdictionary, text) PARALLEL SAFE;
