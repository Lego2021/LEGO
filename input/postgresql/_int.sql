CREATE EXTENSION intarray;
 ...
 \copy test__int from 'data/test__int.data' ANALYZE test__int;
 ...
 SELECT count(*) from test__int WHERE a @@ '!20 & !21';
  ...
  -- not all of these would use index by default  CREATE INDEX text_idx on test__int using gist ( a gist__int_ops );
  SELECT count(*) from test__int WHERE a && '{23,50}';
 SELECT count(*) from test__int WHERE a @@ '23|50';
 SELECT count(*) from test__int WHERE a @> '{23,50}';
 SELECT count(*) from test__int WHERE a @@ '23&50';
